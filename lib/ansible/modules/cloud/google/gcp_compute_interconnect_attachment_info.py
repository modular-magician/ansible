...
- This module was previously called gcp_compute_interconnect_attachment_facts. The
...
def main():
    ...
    if module._name == 'gcp_compute_interconnect_attachment_facts':
        module.deprecate("The 'gcp_compute_interconnect_attachment_facts' has been renamed to 'gcp_compute_interconnect_attachment_info'", version='2.13')
