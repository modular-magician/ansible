...
- This module was previously called gcp_compute_instance_group_manager_facts. The
...
def main():
    ...
    if module._name == 'gcp_compute_instance_group_manager_facts:
        module.deprecate("The 'gcp_compute_instance_group_manager_facts' has been renamed to 'gcp_compute_instance_group_manager_info'", version='2.13')
