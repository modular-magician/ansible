...
- This module was previously called gcp_spanner_instance_facts. The usage has not
  changed
...
def main():
    ...
    module.deprecate("The 'gcp_spanner_instance_facts' has been renamed to 'gcp_spanner_instance_info'", version='2.13')
