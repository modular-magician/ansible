...
options:
  ...
  backend_service:
    ...
    - For internal load balancing, this field identifies the BackendService resource
      to receive the matched traffic. This field is only used for INTERNAL load balancing.
  ...
  network:
    ...
    - For INTERNAL and INTERNAL_SELF_MANAGED load balancing, this field identifies
      the network that the load balanced IP should belong to for this Forwarding Rule.
...
loadBalancingScheme:
  description:
  - This signifies what the GlobalForwardingRule will be used for.
  - The value of INTERNAL means that this will be used for Internal Network Load Balancing
    (TCP, UDP). The value of INTERNAL_SELF_MANAGED means that this will be used for
    Internal Global HTTP(S) LB.
  - The value of EXTERNAL means that this will be used for External Load Balancing
    (HTTP(S) LB, External TCP/UDP LB, SSL Proxy) .
  returned: success
  type: str
...
network:
  description:
  - This field is not used for external load balancing.
  - For INTERNAL and INTERNAL_SELF_MANAGED load balancing, this field identifies the
    network that the load balanced IP should belong to for this Forwarding Rule. If
...
def main():
    ...
    module = GcpModule(
        argument_spec=dict(
            ...
            load_balancing_scheme=dict(type='str', choices=['INTERNAL', 'INTERNAL_SELF_MANAGED', 'EXTERNAL']),
        ...
        mutually_exclusive=[['backend_service', 'target']],
    )
