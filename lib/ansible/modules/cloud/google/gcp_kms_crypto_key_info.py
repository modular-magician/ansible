...
resources:
  ...
  contains:
    ...
    purpose:
      description:
      - The immutable purpose of the CryptoKey. See U(https://cloud.google.com/kms/docs/reference/rest/v1/projects.locations.keyRings.cryptoKeys#CryptoKeyPurpose)
        for inputs.
      returned: success
      type: str
    rotationPeriod:
