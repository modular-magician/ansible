...
resources:
  ...
  contains:
    ...
    purpose:
      description:
      - The immutable purpose of this CryptoKey. See the [purpose reference](U(https://cloud.google.com/kms/docs/reference/rest/v1/projects.locations.keyRings.cryptoKeys#CryptoKeyPurpose))
        for possible inputs.
      returned: success
      type: str
    rotationPeriod:
    ...
    keyRing:
      description:
      - The id of the `KeyRing` to which the key shall belong. Name must be of the
