...
- This module was previously called gcp_compute_https_health_check_facts. The usage
  has not changed
...
def main():
    ...
    if module._name == 'gcp_compute_https_health_check_facts:
        module.deprecate("The 'gcp_compute_https_health_check_facts' has been renamed to 'gcp_compute_https_health_check_info'", version='2.13')
