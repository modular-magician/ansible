  ...
  contains:
      ...
      contains:
        ...
        capacityScaler:
          ...
          - A multiplier applied to the group's maximum servicing capacity (based
            ...
            group will serve up to 100% of its configured capacity (depending on balancingMode).
        ...
        group:
          ...
          - The fully-qualified URL of an Instance Group or Network Endpoint Group
            ...
            zone as the Network Endpoint Group. Backend service can not contain mix
            of Instance Group and Network Endpoint Group backends. Note that you must
            specify an Instance Group or Network Endpoint Group resource using the
      ...
      contains:
        ...
        signedUrlCacheMaxAgeSec:
          ...
          - 'Maximum number of seconds the response to a signed URL request will be
            ...
            response will be revalidated before being served. When serving responses
            to signed URL requests, Cloud CDN will internally behave as though all
    ...
    sessionAffinity:
      ...
      - Type of session affinity to use. The default is NONE. When the load balancing
        scheme is EXTERNAL, can be NONE, CLIENT_IP, or GENERATED_COOKIE. When the
