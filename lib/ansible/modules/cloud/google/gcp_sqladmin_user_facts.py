...
DOCUMENTATION = '''
---
module: gcp_sqladmin_user_facts
description:
...
options:
  instance:
    ...
    - 'This field represents a link to a Instance resource in GCP. It can be specified
      ...
      to a gcp_sqladmin_instance task and then set this instance field to "{{ name-of-resource
      }}"'
    required: true
...
def fetch_list(module, link):
    auth = GcpSession(module, 'sqladmin')
