...
- This module was previously called gcp_compute_ssl_policy_facts. The usage has not
  changed
...
def main():
    ...
    module.deprecate("The 'gcp_compute_ssl_policy_facts' has been renamed to 'gcp_compute_ssl_policy_info'", version='2.13')
