...
- This module was previously called gcp_pubsub_topic_facts. The usage has not changed
...
def main():
    ...
    if module._name == 'gcp_pubsub_topic_facts':
        module.deprecate("The 'gcp_pubsub_topic_facts' has been renamed to 'gcp_pubsub_topic_info'", version='2.13')
