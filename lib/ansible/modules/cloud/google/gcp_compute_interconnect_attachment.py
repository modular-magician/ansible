...
- name: create a interconnect attachment
  gcp_compute_interconnect_attachment:
      ...
      interconnect: 'https://googleapis.com/compute/v1/projects/testProject/global/interconnects/...'
      router: 'https://googleapis.com/compute/v1/projects/testProject/regions/us-central1/routers/...'
...
RETURN = '''
    cloud_router_ip_address:
        description:
            - "[Output Only] IPv4 address + prefix length to be configured on Cloud Router Interface
    ...
    private_interconnect_info:
        ...
        contains:
            tag8021q:
                description:
                    - "[Output Only] 802.1q encapsulation tag to be used for traffic between Google and
                      the customer, going to and from this network and region."
                returned: success
                type: int
    google_reference_id:
        description:
    ...
    id:
        description:
            - "[Output Only] The unique identifier for the resource. This identifier is defined
              by the server."
        returned: success
        type: str
    name:
...
def main():
    ...
    module = GcpModule(
        argument_spec=dict(
            ...
            router=dict(required=True, type='str'),
...
def response_to_hash(module, response):
    return {
        ...
        u'privateInterconnectInfo': InteAttaPrivInteInfo(response.get(u'privateInterconnectInfo', {}), module).from_response(),
        u'googleReferenceId': response.get(u'googleReferenceId'),
        u'operationalStatus': response.get(u'operationalStatus'),
...
class InteAttaPrivInteInfo(object):
