...
- This module was previously called gcp_compute_forwarding_rule_facts. The usage has
  not changed
...
def main():
    ...
    if module._name == 'gcp_compute_forwarding_rule_facts':
        module.deprecate("The 'gcp_compute_forwarding_rule_facts' has been renamed to 'gcp_compute_forwarding_rule_info'", version='2.13')
